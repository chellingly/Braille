...
// CTAA V1.3 Cinematic Temporal Anti-Aliasing Copyright 2017 - 2018 Livenda Labs Pty Ltd 
...
float4 frag (v2f i) : COLOR
{
 ...
 float2  kkjfeiiuueue = _MainTex_TexelSize.xy*0.9;
 ...
 //EYUIAY IHIFAU EN  NFAIUENFN NAFIEUHIU NOAIUFHWEKJNA N FANLEFUHALNF ADKFNFAIUH NFAIKHA NFANIAFNKJN NIAEKKEUR	
	...
	//	float _TdjeKfhjuewennsjdE= 1/lerp (grdiccx*4+_ControlParams.y,0.65,celsotrsm);

	//	_TdjeKfhjuewennsjdE *= 1/(grdiccx+0.65);

	float	_TdjeKfhjuewennsjdE = 1/(grdiccx*20+_ControlParams.y*0.5);

		//_TdjeKfhjuewennsjdE= lerp(3+_ControlParams.y*0.25,_ControlParams.y,saturate(1));
