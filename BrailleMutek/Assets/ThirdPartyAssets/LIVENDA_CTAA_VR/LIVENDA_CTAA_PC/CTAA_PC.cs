...
public class CTAA_PC : MonoBehaviour {
	...
	[Space(5)]
	[Range(0.001f, 2.0f)] public float HdrResponse   = 0.001f;
	[Space(5)]
	[Range(0.0f, 10.0f)] public float Sharpness   = 9.5f;
	[Space(5)]
	[Range(0.2f, 0.5f)] public float AdaptiveEnhance       = 0.32f;
	[Space(5)]
	[Range(0.0f, 0.5f)] public float TemporalJitterScale   = 0.475f;
	[Space(5)]
	[Range(0.01f, 10.0f)] public float MicroShimmerReduction   = 3.0f;
	[Space(5)]
	[Range(0.0f, 1.0f)] public float StaticStabilityPower   = 0.5f;
